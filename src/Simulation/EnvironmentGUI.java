        ...
        for (int x = 0; x < 15; x++) {
            for (int y = 0; y < 15; y++) {
                if (!myEnvironment[x][y].isCow() && !myEnvironment[x][y].isWolf() && !myEnvironment[x][y].isObstacle() && !myEnvironment[x][y].isDog()) {
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("/Users/d.genovese/Desktop/IS/Pratica/labwork_1/IS_TP1_Simulation/src/Images/Ground" + myEnvironment[x][y].getGrass() + ".png"));
                }else if(myEnvironment[x][y].isObstacle()){ 
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("/Users/d.genovese/Desktop/IS/Pratica/labwork_1/IS_TP1_Simulation/src/Images/Obstacle.png"));
                }else if(myEnvironment[x][y].isWolf()){
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("/Users/d.genovese/Desktop/IS/Pratica/labwork_1/IS_TP1_Simulation/src/Images/Wolf.png"));
                }else if(myEnvironment[x][y].isCow()){
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("/Users/d.genovese/Desktop/IS/Pratica/labwork_1/IS_TP1_Simulation/src/Images/Cow.png"));
                }
            }
        }
    }
